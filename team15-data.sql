...
insert into plane values('A100', 'ManufacturerA', 100, '02/17/2010', 1987, '010');
insert into plane values('A150', 'ManufacturerA', 150, '07/12/2010', 1978, '009');
insert into plane values('A200', 'ManufacturerA', 200, '07/21/2010', 1950, '009');
insert into plane values('A220', 'ManufacturerA', 220, '09/10/2010', 1978, '004');
insert into plane values('A230', 'ManufacturerA', 230, '10/01/2010', 1993, '005');
insert into plane values('A250', 'ManufacturerA', 250, '10/25/2010', 1953, '003');
insert into plane values('A280', 'ManufacturerA', 280, '02/17/2011', 1977, '002');
insert into plane values('A290', 'ManufacturerA', 290, '07/05/2011', 1974, '005');
insert into plane values('A300', 'ManufacturerA', 300, '09/05/2011', 1983, '007');
insert into plane values('A999', 'ManufacturerA', 999, '09/29/2011', 1988, '003');
insert into plane values('B050', 'ManufacturerB',  50, '01/28/2012', 1960, '002');
insert into plane values('B100', 'ManufacturerB', 100, '03/21/2012', 1968, '007');
insert into plane values('B120', 'ManufacturerB', 120, '11/08/2012', 1961, '008');
insert into plane values('B130', 'ManufacturerB', 130, '02/07/2013', 1987, '001');
insert into plane values('B140', 'ManufacturerB', 140, '02/19/2013', 1956, '001');
insert into plane values('B150', 'ManufacturerB', 150, '06/09/2013', 1958, '009');
insert into plane values('B170', 'ManufacturerB', 170, '11/03/2013', 1972, '004');
insert into plane values('B211', 'ManufacturerB', 211, '02/11/2014', 1996, '003');
insert into plane values('B222', 'ManufacturerB', 222, '08/06/2014', 1973, '004');
insert into plane values('B999', 'ManufacturerB', 999, '08/28/2014', 1970, '008');
insert into plane values('C020', 'ManufacturerC',  20, '10/24/2014', 1958, '006');
insert into plane values('C050', 'ManufacturerC',  50, '06/30/2015', 1951, '007');
insert into plane values('C070', 'ManufacturerC',  70, '07/12/2015', 1965, '007');
insert into plane values('C090', 'ManufacturerC',  90, '09/15/2015', 1976, '009');
insert into plane values('C100', 'ManufacturerC', 100, '12/10/2015', 1978, '006');
insert into plane values('C999', 'ManufacturerC', 999, '04/08/2010', 1951, '002');
insert into plane values('D100', 'ManufacturerD', 100, '07/11/2010', 1995, '001');
insert into plane values('D200', 'ManufacturerD', 200, '11/20/2012', 1951, '002');
insert into plane values('D300', 'ManufacturerD', 300, '10/20/2013', 1991, '002');
insert into plane values('D999', 'ManufacturerD', 999, '02/14/2015', 1984, '004');
